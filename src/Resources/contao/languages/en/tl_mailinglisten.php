...
$GLOBALS['TL_LANG']['tl_mailinglisten']['basisUrl'] = array('Base address of the website', 'Required for the unsubscribe button mail programs offer through the List-Unsubscribe header, e.g. https://www.example.org. The cron job runs without a page request and cannot determine the address itself. Left empty, the button is omitted; unsubscribing by subject and the visible notice in the footer are unaffected.');
...
$GLOBALS['TL_LANG']['tl_mailinglisten']['anonymErlaubt'] = array('Allow anonymous posting', 'Members can then have their contributions appear without name and address. If the permission is withdrawn later, members who are already anonymous stay anonymous — suddenly showing their names would be a breach of trust.');
