...
$GLOBALS['TL_LANG']['tl_mailinglisten']['basisUrl'] = array('Basisadresse der Webseite', 'Nötig für den Abmeldeknopf, den Mailprogramme über die Kopfzeile List-Unsubscribe anbieten — etwa https://www.example.org. Der Cronjob läuft ohne Seitenaufruf und kann die Adresse nicht selbst ermitteln. Bleibt das Feld leer, entfällt der Knopf; die Abmeldung per Betreff und der sichtbare Hinweis in der Fußzeile bleiben davon unberührt.');
...
$GLOBALS['TL_LANG']['tl_mailinglisten']['anonymErlaubt'] = array('Anonymes Schreiben erlauben', 'Teilnehmer können ihre Beiträge dann ohne Name und Adresse erscheinen lassen. Wird die Erlaubnis später entzogen, bleiben bereits anonyme Teilnehmer anonym — sie plötzlich mit Namen erscheinen zu lassen, wäre ein Vertrauensbruch.');
$GLOBALS['TL_LANG']['tl_mailinglisten']['anonymKennung'] = array('Kennwort für anonymes Schreiben', 'Steht dieses Wort am Anfang des Betreffs, schaltet der Teilnehmer zwischen anonym und Klarnamen um. Anonyme Beiträge erscheinen ohne Name und Adresse; Antworten gehen dann immer an die Liste, nie an den Verfasser. Ein leeres Feld schaltet die Funktion ab.');
...
$GLOBALS['TL_LANG']['tl_mailinglisten']['ablehnungMelden'] = array('Abweisungen an die Betreuung melden', 'Die oben genannten Adressen erfahren von jeder abgewiesenen Nachricht, mit Absender, Betreff, Grund und dem Anfang des Textes. Bei einer Adresse, die viel Spam bekommt, besser abschalten.');
